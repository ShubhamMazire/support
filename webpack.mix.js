...
mix.js('resources/assets/js/app.js', 'public/assets/js').
    ...
    'public/assets/js/custom/custom-datatable.js').js('resources/assets/js/custom/input_price_format.js',
    'public/assets/js/custom/input_price_format.js').js('resources/assets/js/custom/currency.js',
    'public/assets/js/custom/currency.js').js('resources/assets/js/user_profile/user_profile.js',
    'public/assets/js/user_profile/user_profile.js').js('resources/assets/js/users/users.js',
    'public/assets/js/users/users.js').js('resources/assets/js/users/create_edit.js',
